 ...
 * @LastEditors: zpliu
 * @LastEditTime: 2024-07-22 20:57:51
 * @@param: 
-->
<template>
  <el-row justify="center" :gutter="10" align="top" class="itemDat">
...
const publicationHTML = function (dat, queryName) {
  ...
  let year = dat["year"];
  let rawStr = `${firstAuthorStr}${otherAuthorStr}${correspindingStr}${title}. <span style="font-style: italic; font-weight:bold;">${journal}. </span>${year}; ${volume}.`;
  // 搜索名字对字符进行修改
